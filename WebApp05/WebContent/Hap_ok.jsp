...
<% 
	...
	// 이전 페이지로(Hap.jsp)부터 넘어온 데이터(su1, su2) 수신
	...
	catch(Exception e)
	{
		...
		System.out.println(e.toString());					// 검정글씨로 나오는 것  For input string: "df"
		
		// 예외 발생 시
		// 해당 내용을 서버 log 기록으로 남기는 처리...
		getServletContext().log("오류 : " + e.toString());	// 빨간색으로 나오는 것  For input string: "df"
	}
